 ...
 */
public class HybridWebGuestActivity extends BaseWebActivity {
	
	private final String TAG = HybridWebGuestActivity.class.getName();
	/**
	...
	public static void invokeActivity(Context context, int res) {
		Intent intent = new Intent(context, HybridWebGuestActivity.class);
