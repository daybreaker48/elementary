...
import com.mhd.stard.common.SslAlertDialog;
...
import com.mhd.stard.webview.views.CustomProgressDialog;
...
//		}
	...
	public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
		...
		SslAlertDialog sslAlertDialog = new SslAlertDialog(handler, view.getContext());
		sslAlertDialog.show();
//		if(handler != null) {
//			handler.proceed();
//		} else {
